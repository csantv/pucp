...
asignacion: ID {$$=localizaSimbolo(lexema,ID);} IGUAL cond  {generarCodigo(ASIGNAR,$2,$4,'-');} ;
...
factor  : NUMBER {$$=localizaSimbolo(lexema,NUMBER);} 
        ...
        | '(' expr ')'  {$$=$2;}
        ;
impresion: MUESTRA ID {generarCodigo(IMPRIMIR,$2,'-','-');} | MUESTRA NUMBER /*completar*/;
...
lectura: LECTURA {  generarCodigo(LEER,'-','-','-') ID /*completar*/ };
